...
public class PruebaMatrices {
	...
	public static void main(String[] args) {
		...
		// Pedimos el numero de filas y columnas advertimos de que no se puede exceder
		// de ciertos valores
		// Pero no hacemos nada sino se cumplen para que el metodo nos devuelva el valor
		// null si procede
		System.out.println("El numero de filas y columnas debe estar entre 1 y 26");
		...
		// Vamos a solitar el numero de columnas hasta que sea un número mayor o igual a
		// 3
		do {
		...
		// Para este ejemplo la matriz se llena mediante un metodo donde rellena la
		// matriz
		...
		// llamamos al metodo y nos devuelve la mayor suma que se obtiene de todos los
		// resultados, sumando los elementos de cada matriz de 3 x 3 que contiene la
		// matriz original
		int SumMax = Matrices.max3x3sum(matrizNxM);

		// Imprimimimos el valor maximo
		System.out.println(
				"La mayor suma de todos los elementos de cada una de las matrices de 3x3 contenidas en esta matriz es = "
						+ SumMax);
